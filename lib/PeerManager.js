...
var luxcoreDefaults = require('../config');
...
function PeerManager(config) {
  ...
  this.config = config || {};
  for (var i in luxcoreDefaults)
    if (luxcoreDefaults.hasOwnProperty(i) && this.config[i] === undefined)
      this.config[i] = luxcoreDefaults[i];
